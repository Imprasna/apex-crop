...
//                   <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white" onClick={() => setIsTournamentRegistrationOpen(true)}>
//                     Register Now
...
//                     <Button className="w-full bg-primary hover:bg-primary/90" onClick={() => setIsRegistrationModalOpen(true)}>
//                       Register Now
...
//               <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white px-8 py-4 text-lg" onClick={() => setIsRegistrationModalOpen(true)}>
...
//       {/* <RegistrationClosedModal isOpen={isRegistrationModalOpen} onClose={() => setIsRegistrationModalOpen(false)} /> */}

//          {/* Tournament Registration Modal */}
//       <TournamentRegistrationModal isOpen={isTournamentRegistrationOpen} onClose={() => setIsTournamentRegistrationOpen(false)}
//       />
//     </div>
//   )
// }
